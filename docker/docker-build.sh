...
sudo docker buildx build --progress plain --platform linux/x86_64,linux/arm64 -t us-docker.pkg.dev/abacus-llm/llm-images/${IMAGE_NAME}:${TAG} --push .
